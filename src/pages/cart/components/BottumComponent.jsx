...
function BottumComponent() {
    ...
    const shopData = {
        latitude: "11.178668",
        longitude: "75.8625612",
        delivery_radius: "50", // Delivery radius in kilometers
    };
    ...
    return (
        <div className="fixed sm:max-w-[560px] bottom-0 w-full bg-gradient-to-r from-gray-800 to-gray-900 text-white py-3 px-4 rounded-t-xl shadow-lg flex justify-between items-center">
            ...
            <button
                ...
                className={`btn ${isDeliveryAvailable ? 'btn-warning' : 'btn-gray-400'} text-white text-sm font-semibold py-2 px-4 rounded-md shadow`}
            >
